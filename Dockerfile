...
ADD https://ftp.mozilla.org/pub/mozilla.org/webtools/bugzilla-5.1.2.tar.gz /tmp/
RUN tar -xvf /tmp/bugzilla-5.1.2.tar.gz -C /var/www/
RUN ln -s /var/www/bugzilla-5.1.2 /var/www/html
